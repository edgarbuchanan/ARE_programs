...
for index_individual=1:number_individuals   
   ...
   population_plus_fitnesses(index_individual).fitness=(9-individual_fitness)^2; %Fitness function as defined by Kenneth Stanley    
   if sum(abs(round(output)-output_pattern))==0      
      population_plus_fitnesses(index_individual).fitness=81;
      display(output)
   end
end
