...
maximale_previous_fitness = 0; % Edgar
%%%
%%%
%%%  Generational Loop
%%%
...
while generation<maxgeneration & flag_solution==0
   ...
   if maximale_fitness>80.9 % Edgar Thereshold changed

      flag_solution=1;
   end
   if(maximale_fitness > maximale_previous_fitness) % Edgar Store best solution
       maximale_previous_fitness = maximale_fitness;
       [abc, idx] =  max([population.fitness]);
